    ...
    Firestore.instance.collection('users').document(widget.snap.data['ReceiverID']).get().then((snap) {
      ...
      setState(() {
        switch(widget.snap.data['HappyStatus']) {
          case 1:
            snap.data['sadImage'] == null ? _happyImageUrl = "" : _happyImageUrl = snap.data['sadImage'];
            _happyText = "Really???";
            break;
          case 2:
            snap.data['neutralImage'] == null ? _happyImageUrl = "" : _happyImageUrl = snap.data['neutralImage'];
            _happyText = "You can do better ;)";
            break;
          case 3:
            snap.data['happyImage'] == null ? _happyImageUrl = "" : _happyImageUrl = snap.data['happyImage'];
            _happyText = "Gooood job :)";
            break;
          case 4:
            snap.data['veryHappyImage'] == null ? _happyImageUrl = "" : _happyImageUrl = snap.data['veryHappyImage'];
